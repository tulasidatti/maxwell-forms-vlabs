...
(function() {
  ...
  _Message = (function(_super) {
    ...
    _Message.prototype.template = function(opts) {
      ...
      // we are testing for the presence of <script . . . > tags, and removing them, returning only the string.
      while (SCRIPT_REGEX.test(opts.message)) {
          opts.message = opts.message.replace(SCRIPT_REGEX, "");
      }
